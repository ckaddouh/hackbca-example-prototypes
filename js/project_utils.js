...
function confirmDelete(event_name, event_id, redirect_to){
    if(confirm(`Are you sure you want to delete the project ${event_name} (id ${event_id})? This is PERMANENT and cannot be undone.`)) {
        //TODO: make delete request
        alert(`Successfully deleted the project ${event_name} (id ${event_id}).`);
